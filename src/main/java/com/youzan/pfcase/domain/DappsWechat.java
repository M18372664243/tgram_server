 ...
 */
public class DappsWechat implements Serializable {
	...
	public int getDappgroup() {
		return dappgroup;
	}

	public void setDappgroup(int dappgroup) {
		this.dappgroup = dappgroup;
	}
